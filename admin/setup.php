...
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="update">';
print '<input type="hidden" name="constname" value="KEYCLOAK_CREATE_USER">';
print '<input type="hidden" name="constnote" value="">';
print $langs->trans('DescKEYCLOAK_CREATE_USER');
print '</td>';
print '<td>';
print $form->selectyesno('constvalue', $conf->global->KEYCLOAK_CREATE_USER, 1);
print '<input type="hidden" name="consttype" value="chaine">';
print '</td>';
print '<td align="center">';
print '<input type="submit" class="button" value="'.$langs->trans("Update").'" name="Button">';
